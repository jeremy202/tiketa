<template>
  <div class="min-h-screen bg-grid pt-[200px] pb-16">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
        ...
        <div class="glass-card rounded-2xl p-5">
          <div class="flex items-center gap-3 mb-2">
            <div
              class="w-10 h-10 rounded-xl bg-accent-blue/20 flex items-center justify-center"
            >
      ...
      <div v-if="filteredApplications.length > 0" class="space-y-4">
        ...
        >
          <TicketCard
            ...
            :event="getEvent(application.eventId) || undefined"
          />
        </TransitionGroup>
      </div>
...
const tabs = computed(() => [
  { label: "All", value: "all", count: applicationsStore.applications.length },
  {
    label: "Confirmed",
    value: "paid",
    count: applicationsStore.getPaidApplications.length,
  },
  {
    label: "Pending",
    value: "pending",
    count: applicationsStore.getPendingApplications.length,
  },
]);
...
const emptyStateConfig = computed(() => {
  if (activeTab.value === "pending") {
    return {
      ...
      description:
        "You have no pending payments. All your applications are confirmed!",
  ...
  if (activeTab.value === "paid") {
    return {
      ...
      description:
        "Complete payment for your applications to see your tickets here.",
      actionText: "Browse Events",
...
onMounted(async () => {
  ...
  notificationsStore.checkUpcomingEvents(
    eventsStore.events,
